                                ...
                                child: Container(
                                  child: ListView(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Text('Umur: ' +  umur.toString().substring(0,2)),
                                      Text('Jenjang Pendidikan:'),
                                      if(jenjangDiploma) Text('Diploma'),
                                      if (jenjangSarjana) Text('Sarjana'),
                                      if (jenjangMagister) Text('Magister'),
                                      if (jenjangDoktor) Text('Doktor'),
